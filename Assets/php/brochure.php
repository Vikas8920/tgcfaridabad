...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $to = "info@tgcfaridabad.com, faridabad.tgc@gmail.com";  
    $subject = "New Form Submission: Download Brochure Form, TGC Faridabad";
    ...
    if (mail($to, $subject, $message, $headers)) {
        ...
        header("Location: https://tgcfaridabad.com/thank-you/");
        exit; 
